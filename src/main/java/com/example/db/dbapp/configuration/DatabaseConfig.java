package com.example.db.dbapp.configuration;
...
import com.example.db.dbapp.entities.*;;
...
public class DatabaseConfig extends AbstractCloudConfig {
	...
	@Value("${vcap.services.mysql-db.credentials.hostname}")
	private String hostname;

	@Value("${vcap.services.mysql-db.credentials.port}")
	private String port;

	@Value("${vcap.services.mysql-db.credentials.dbname}")
